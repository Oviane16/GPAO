...
<div style="background-image:url('image/foote.PNG');">
    <h1 style="color:violet;background-image:url('image/t.PNG');" align="center">Enregistrement de travail</h1>
...
<td>
	...
	<p>
      <td colspan="2">
            <img src="image/login.jpg" width="78px" height="21px" name="enregistre" border="0" onclick="enreg()" />
      </td>
</tr>
    <tr align="center">
