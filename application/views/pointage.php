    ...
    <script language="javascript">
        ...
        function typepointage(){
            $.ajax({
                    ...
                    //url:"http://192.168.10.122/mikiry/ajaxpointage2.php",
                    method: 'post',
                    data: {
        ...
        function enregistrer(){
            $.ajax({
                    ...
                    //url:"http://192.168.10.122/mikiry/ajaxpointage.php",
                    method: 'post',
                    data: {
                        'motdepasse': $('[name="motdepasse"]') . val(),
                        'matricule': $('[name="matricule"]') . val(),
...
<table ALIGN="center" width="30%">
    <tr ><td>
            <div style="background-image:url('<?php img_url('foote.PNG') ?>');">
                <h1 style="color:violet;background-image:url('<?php img_url('t.PNG') ?>');" align="center">Pointage MIKIRY</h1>
