...
<head>
    ...
    <link href="<?php echo css_url('bootstrap-table.css'); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo css_url('bootstrap-editable.css'); ?>" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="assets/examples.css">
    <script src="<?php echo js_url('jquery.min.js');?> " type="text/javascript"> </script>
    <script src="<?php echo js_url('bootstrap.minjs');?> " type="text/javascript"> </script>
