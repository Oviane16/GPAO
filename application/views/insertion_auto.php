<script>
    $(document).ready(function() {
        $("#preparation").click(function(){
            ...
            $.ajax({
                type: "POST",
                //url: "http://localhost/mikiry/index.php/insertion_auto_contr/affichage" ,
                url: "http://localhost/mikiry_local/index.php/insertion_auto_contr/affichage" ,
                beforeSend :function()
                   {
                    if($(".loading").length == 0 )
                    {
...
<legend> Preparation automatique</legend>
<div id="form_lot">
