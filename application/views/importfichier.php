...
function password(){
    $.ajax({
        url: "http://localhost/mikiry/remplirformulaire.php",
        //url: "http://192.168.10.122/mikiry/remplirformulaire.php",
        method: 'post',
        data: {
...
//        alert(element.nodeValue.indexOf('='));
        $.ajax({
            url: "http://localhost/mikiry/importation.php",
            //url: "http://192.168.10.122/mikiry/importation.php",
            method: 'post',
            data: {
                'matricule': $('[name="matricule"]').val(),
            },
...
//        alert(element.nodeValue.indexOf('='));
        $.ajax({
            url: "http://localhost/mikiry/exportation.php",
            //url: "http://192.168.10.122/mikiry/exportation.php",
            method: 'post',
            data: {
                'matricule': $('[name="matricule"]').val(),
            },
...
<table ALIGN="center" width="30%">
  ...
  <td><img src="<?php echo img_url('importer.jpg') ?>" width="78px" height="21px" name="importer" border="0"  onclick="importation()" disable/></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td></td>
                            ...
                            <td><img src="<?php echo img_url('exporter.jpg'); ?>" width="78px" height="21px" name="exporter" border="0" onclick="exportation()" disable/></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td></td>
