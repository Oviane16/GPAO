...
?>
    <script type="text/javascript">
        ...
        function password(){
            $.ajax({
                url: "http://localhost/mikiry/index.php/routeur/suppressionlot/",
               // url: "http://192.168.10.122/mikiry/index.php/routeur/suppressionlot/",
                method: 'post',
                data: {
                ...
                success: function (data) {
                    ...
                    if (data.valide == false) {
                        ...
                        document.getElementById("validation").src = "<?php echo img_url('stop.jpg') ?>";
                    } else {
                        $('#LblClignotant').html(data.alerte);
                        document.getElementById("validation").src = "<?php echo img_url('login.jpg') ?>";
...
<table ALIGN="center" width="30%">
	...
	font-size: 18px;" onchange="password()" value= "<?php if (!empty ($motdepasse)) echo $motdepasse; else echo "Passe"; ?>"></td>
                            <td><img src="<?php echo img_url('stop.jpg') ?>" width="78px" height="21px" id="validation" border="0"  onclick="suppression()" disable/></td>
                            <td></td>
                        </tr>
                        <tr align="center">
                            <td></td>
