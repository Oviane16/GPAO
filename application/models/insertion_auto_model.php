...
class Insertion_auto_model extends CI_Model
{
...
// Une fois que tous les champs ont bien été définis, on "insert"
    ...
    public function get_insertionFICHIER($SousRepert,$command,$rep,$RepertoireACreer,$id_preparation,$traitement,$export,$idcommande,$fic,$dossier)
    {
