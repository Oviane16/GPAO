...
class Preparation_s_m_model extends CI_Model
{
...
// Une fois que tous les champs ont bien été définis, on "insert"
  ...
  public function get_insertionFICHIER($command,$izl,$RepertoireACreer,$SousRepert,$id_preparation,$traitement,$export,$idcommande,$fic,$dossier)
{
