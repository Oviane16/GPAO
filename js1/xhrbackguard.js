function sendRequest(url, payload, categoryName, callback, addToHistory)
{
...
function selectFiles(categoryName, addToHistory)
{
    ...
    sendRequest(url, payload, categoryName, handlePhotosResponse, addToHistory);
